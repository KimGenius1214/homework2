...
<%       
        ...
        try{
           ...
           if(conn != null){
              sql = "select mem_idx, mem_userid, mem_name, mem_hp, mem_email, mem_hobby, mem_ssn1, mem_ssn2, mem_zipcode, mem_address1, mem_address2, mem_address3 from tb_member where mem_userid=?";
...
<body>
    ...
    <form action="./info_ok.jsp" method="post" name="regform" id="regform" onsubmit="return sendit()">
        ...
        %>
        ></label> <label>영화감상<input type="checkbox"
                    name="hobby" value="영화감상" <%
           for(int i = 0; i<hobbyArr.length; i++){
        ...
        %>
        ></label> <label>게임<input type="checkbox"
                    name="hobby" value="게임" 
                    <%
           for(int i = 0; i<hobbyArr.length; i++){
        ...
        <p>세부주소 : <input type="text" name="address2" id="sample6_detailAddress" value="<%=mem_address2%>"></p>
        <p>참고항목 : <input type="text" name="address3" id="sample6_extraAddress" value="<%=mem_address3%>"></p>
        <p><input type="submit" value="수정 완료"> <input type="reset" value="다시작성"> <input type="button" value="뒤로가기" onclick="history.back()">
</p>
    </form>
</body>
</html>
