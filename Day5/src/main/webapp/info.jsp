...
<body>
    ...
    <form action="./info_ok.jsp" method="post" name="regform" id="regform" onsubmit="return sendit()">
        ...
        <p>이름 : <input type="text" name="name" id="name" value="<jsp:getProperty property="username" name="member"/>"></p>
        <p>휴대폰 번호 : <input type="text" name="hp" id="hp" value="<jsp:getProperty property="hp" name="member"/>"></p>
        <p>이메일 : <input type="text" name="email" id="email" value="<jsp:getProperty property="email" name="member"/>"></p>
        <p>취미 : 
        ...
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" value="<jsp:getProperty property="ssn1" name="member"/>" readonly> - <input type="text" name="ssn2" id="ssn2" maxlength="7" value="<jsp:getProperty property="ssn2" name="member"/>" readonly></p>
        <p>우편번호 : <input type="text" name="zipcode" id="sample6_postcode" value="<jsp:getProperty property="zipcode" name="member"/>"> <input type="button" value="우편번호 검색" onclick="sample6_execDaumPostcode()"></p>
        <p>주소 : <input type="text" name="address1" id="sample6_address" value="<jsp:getProperty property="address1" name="member"/>"></p>
        <p>상세주소 : <input type="text" name="address2" id="sample6_detailAddress" value="<jsp:getProperty property="address2" name="member"/>"></p>
        <p>참고항목 : <input type="text" name="address3" id="sample6_extraAddress" value="<jsp:getProperty property="address3" name="member"/>"></p>
